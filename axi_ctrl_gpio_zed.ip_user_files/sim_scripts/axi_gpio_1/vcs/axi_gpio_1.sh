...
design_libs=(xpm axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_4 axi_gpio_v2_0_30 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_gpio_1 xil_defaultlib.glbl -o axi_gpio_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_gpio_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_gpio_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_gpio_1_simv.daidir vcs_lib c.obj)
