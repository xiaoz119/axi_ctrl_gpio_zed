...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_30 -L xil_defaultlib -L secureip -L xpm --snapshot axi_gpio_0 xil_defaultlib.axi_gpio_0 -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="H:/AMD/Vivado/2023.1/data/xsim"
  fi
